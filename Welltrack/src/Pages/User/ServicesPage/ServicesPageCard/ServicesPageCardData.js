...
import Droplets from "@/assets/images/features/pulse_health.svg";

const servicesData = [
  {
    image: Stethoscope,
    title: "Doctor Visits",
    description: "Schedule appointments with medical specialists and track your consultations",
    href: "/services/doctor-visit",
  },
  {
    image: Syringe,
    title: "Vaccination",
    description: "Manage your vaccination schedule and track immunization history",
